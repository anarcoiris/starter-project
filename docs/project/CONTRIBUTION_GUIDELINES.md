...
1. [Architecture Violations](../architecture/ARCHITECTURE_VIOLATIONS.md)
2. [Code Quality Violations](../architecture/CODING_GUIDELINES.md)
3. [App Architecture](../architecture/APP_ARCHITECTURE.md)