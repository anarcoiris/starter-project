...
ARTICLE_VALIDATOR = {
    "$jsonSchema": {
        ...
        "properties": {
            ...
            "expectedReadTime": {"bsonType": ["int", "long", "double"]},
            "qualityScore": {"bsonType": ["int", "long", "double"]},
            "fraudScore": {"bsonType": ["int", "long", "double"]},
            "rewardEpoch": {"bsonType": ["int", "long"]},
            "verifiedImpressionCount": {"bsonType": ["int", "long"]},
        },
    }
}
